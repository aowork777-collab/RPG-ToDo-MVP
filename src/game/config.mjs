...
export const MAX_BATTLE_LEVEL = 100;
export const BOSS_INTERVAL = 5;
export const CAMPAIGN_VERSION = 1;

export const PLAYER_HOME = Object.freeze({ x: 220, y: 412 });
export const ENEMY_HOME = Object.freeze({ x: 740, y: 412 });

export const ARENA_IMAGE_URL = new URL("../../assets/game/moonlit-arena.png", import.meta.url).href;
